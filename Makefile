...
unit-test:
	...
	mvn clean install -Dmaven.test.skip=true -Dsurefire.useFile=false -f ./lib/pom.xml
	mvn clean install -Dmaven.test.skip=true -DskipTests ./api/pom.xml
	mvn clean install -Dmaven.test.skip=true ./application/pom.xml
